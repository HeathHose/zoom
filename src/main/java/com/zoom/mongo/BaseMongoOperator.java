...
/**
 * Created by liangbo.zhou on 18-4-26.
 */
public class BaseMongoOperator<E> {
    /** 日志对象 */
    private static final Logger logger = LogManager.getLogger(BaseMongoOperator.class);
     ...
     *  throws
     */
    public List<E> findListByPage(Criteria c, List<Sort.Order> orders, int pageIndex,
                                  int pageSize){
     ...
     *  throws
     */
    public List<E> findListByPage(List<Sort.Order> orders, int pageIndex,
    ...
    @SuppressWarnings("rawtypes")
    public List<E> findList(Map<String, Object> eqMap,
                                  Map<String, Object> gtMap, Map<String, Object> ltMap,
                                  Map<String, Object> gteMap, Map<String, Object> lteMap,
                                  Map<String, String> regexMap, Map<String, Collection> inMap,
